...
namespace ILRuntime.Runtime.Enviorment
{
    ...
    public class AppDomain
    {
        ...
        public unsafe AppDomain()
        {
            ...
            dMgr.RegisterDelegateConvertor<ETModel.DoHideAnimationEvent>((act) =>
            {
           ...
           dMgr.RegisterDelegateConvertor<FairyGUI.PlayCompleteCallback>((act) =>
            {
            ...
            dMgr.RegisterDelegateConvertor<ETModel.DoShowAnimationEvent>((act) =>
            {
            ...
            dMgr.RegisterDelegateConvertor<ETModel.OnHideEvent>((act) =>
            {
